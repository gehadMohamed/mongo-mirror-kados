...
$clauseWhereElementsGetAll=" AND us_id_fk IN (SELECT us_id FROM kados_user_stories WHERE active=1 AND us_release_id_fk=".$_SESSION['current_release_id']." AND us_sprint_id_fk=0)".$restrictionClauseOnStatus;
