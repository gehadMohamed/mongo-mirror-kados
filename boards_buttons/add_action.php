...
?>
<h3 class="popupTitle"><?php echo $legend_creation_f.' '.lcfirst($text_action);?></h3>
...
<form action="<?php echo $targetFileAction;?><?php echo (isset($_REQUEST['blockId']) ? '&a='.md5(time()).'#Block'.$_REQUEST['blockId'] : '');?>" method="post" class="note-form" enctype="multipart/form-data" name="form_action">
