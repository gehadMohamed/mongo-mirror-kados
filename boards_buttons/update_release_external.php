...
<input type="hidden" name="action" value="update_release_ext" />
<input type="hidden" name="release_2update_id" id="release_2update_id" value="<?php echo $_REQUEST['release_id'];?>" />
 <fieldset class="fieldset">
   ...
   <input class="readonly_form_field" class="readonly" readonly="readonly" name="form_item_release" id="form_item_release" type="text" size="15" value="<?php echo $releaseData->release_name;?>" /><div class="clearleft"></div>
  
   <label class="label required_field100" ><?php echo $text_due_date;?></label>
   <input class="readonly_form_field" readonly="readonly" name="form_item_due_date" id="form_item_due_date" value="<?php echo convert_date($releaseData->release_due_date);?>" type="text" size="10"/>
