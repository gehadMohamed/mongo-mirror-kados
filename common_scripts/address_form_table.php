...
?> 
  ...
  <tr>
  <td> 
    <label class="label <?php echo $field_required;?>100" ><?php echo $text_address.' '.$text_project;?></label>
    <input <?php if ($_REQUEST['action']=='view_details') {echo 'class="readonly_form_field"'; } else { echo 'class="std_form_field"'; } ?> name="form_item_address<?php echo $address_tag;?>_street1" type="text" size="35" value="<?php echo $address_data->address_street;?>" <?php if ($_REQUEST['action']=='view_details') {echo 'readonly="readonly"'; } ?> /><div class="clearleft"></div>
  </td>
  <td>    
    <label class="label <?php echo $field_required;?>50" ><?php echo $text_address_zip_code;?></label>
  ...
  <tr>
  <td>  
    <label class="label length100" ><?php echo $text_address_comment;?></label>
    <input <?php if ($_REQUEST['action']=='view_details') {echo 'class="readonly_form_field"'; } else { echo 'class="std_form_field"'; } ?> name="form_item_address<?php echo $address_tag;?>_street2" type="text" size="35" value="<?php echo $address_data->address_street_comments;?>" <?php if ($_REQUEST['action']=='view_details') {echo 'readonly="readonly"'; } ?> /><div class="clearleft"></div>
  </td>  
  <td>  
    <label class="label <?php echo $field_required;?>50" ><?php echo $text_address_city;?></label>
  ...
  <td>  
    <label class="label length50" ><?php echo $text_address_country;?></label>
